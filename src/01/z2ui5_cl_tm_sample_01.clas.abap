CLASS z2ui5_cl_tm_sample_01 DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS z2ui5_cl_tm_sample_01 IMPLEMENTATION.
  ...
  METHOD call_f4.
    ...
    client->nav_app_call( z2ui5_cl_tm_pop_value_help=>factory( i_table = f4_table
                                                         i_fname = f4_field
                                                         i_value = mv_arbgb ) ).
