CLASS z2ui5_cl_tm_sm30_01 DEFINITION
  PUBLIC
  CREATE PUBLIC.
  ...
  PROTECTED SECTION.
    ...
    DATA ms_transport      TYPE z2ui5_cl_tm_pop_tr=>ty_s_data.
...
CLASS z2ui5_cl_tm_sm30_01 IMPLEMENTATION.
  ...
  METHOD button_save.
    ...
    IF ms_transport IS INITIAL.
      ...
      client->nav_app_call( z2ui5_cl_tm_pop_tr=>factory( ) ).
    ...
    ELSE.
      ...
      z2ui5_cl_tm_pop_tr=>add_DATA_to_tranport( ir_data      = t_table
                                                    iv_tabname   = mv_table
                                                    is_transport = ms_transport ).

      z2ui5_cl_tm_pop_tr=>add_DATA_to_tranport( ir_data      = t_table_del
                                                    iv_tabname   = mv_table
                                                    is_transport = ms_transport ).
...
*                           press = client->_event( 'BUTTON_EDIT' ) ).
  ...
  METHOD row_select.
    ...
    client->nav_app_call( z2ui5_cl_tm_sm30_02=>factory( io_table     = mt_table
                                                     iv_row_id    = ls_arg
                                                     it_dfies     = mt_dfies
                                                     io_layout    = mo_layout
...
*    DATA(lgnum) = ZSM30_cl_parameter_helper=>get_parameter_id( '/SCWM/LGN'  ).
  ...
  METHOD on_after_transport.
    ...
    TRY.
        " War es das Layout?
        DATA(app) = CAST z2ui5_cl_tm_pop_tr( client->get_app( client->get( )-s_draft-id_prev_app ) ).
...
*                                                      fixedrowcount       = '1'
  ...
  METHOD on_after_popup.
    ...
    TRY.
        DATA(app) = CAST z2ui5_cl_tm_sm30_02( client->get_app( client->get( )-s_draft-id_prev_app ) ).
